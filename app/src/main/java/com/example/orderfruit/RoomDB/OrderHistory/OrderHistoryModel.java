...
public class OrderHistoryModel {
    ...
    public OrderHistoryModel(int orderid, String ordername, String orderaddress, String orderprice, String orderphone, String orderphone2, String orderstats, String orderdate, String orderquanity, String orderfruitID, String orderWeight) {
    ...
    @Ignore
    public OrderHistoryModel(String ordername, String orderaddress, String orderprice, String orderphone, String orderphone2, String orderstats, String orderdate, String orderquanity, String orderfruitID, String orderWeight) {
        this.ordername = ordername;
        this.orderaddress = orderaddress;
        this.orderprice = orderprice;
        this.orderphone = orderphone;
