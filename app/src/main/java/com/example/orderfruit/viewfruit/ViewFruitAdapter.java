...
public class ViewFruitAdapter extends RecyclerView.Adapter<ViewFruitAdapter.holder> {
    ...
    public ViewFruitAdapter(ArrayList<FruitDataModel> arrayList, Context context, InterfaceData interfaceData, String GetUserId) {
    ...
    public void onBindViewHolder(@NonNull holder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.fresh_favourite_fruit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //SQLiteData sqLiteData=new SQLiteData(context);
                boolean check = commonDB.favouriteDAO().checkInFavourite(GetUserId, arrayList.get(position).getFruit_id());
    ...
    class holder extends RecyclerView.ViewHolder {
        ...
        ImageView fresh_fruit_image, fresh_favourite_fruit;
...
//            allfruits_cardview=itemView.findViewById(R.id.allfruits_cardview);
            ...
            fresh_favourite_fruit = itemView.findViewById(R.id.allfruits_favourite);
